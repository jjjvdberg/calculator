    ...
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #1 (MultiplyResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "MultiplyResponse")));
        // Type #2 (BaseRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS1, "BaseRequest")));
        // Type #3 (MultiplyRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "MultiplyRequest")));
        // Type #4 (ErrorData)
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addSimpleElement(new QName(NS1, "timestamp"), 1);
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(6), -1);
        currType.addSimpleElement(new QName(NS2, "y"), 1);
        ...
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(6), -1);
        currType.addSimpleElement(new QName(NS2, "x"), 1);
        currType.addSimpleElement(new QName(NS2, "y"), 1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "multiplyRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "multiplyRequest"), complexTypes.get(3)));
        rootElements.put(new QName(NS2, "multiplyResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "multiplyResponse"), complexTypes.get(1)));
    }
