 ...
 * 
 */
public class SharedMultiplyServiceConsumer
    implements AsyncMultiplyService
{

    private URL m_serviceLocation = null;
    private final static String SVC_ADMIN_NAME = "MultiplyService";
    private String m_clientName;
    private String m_environment = "production";
    private AsyncMultiplyService m_proxy = null;
    private String m_authToken = null;
    private Cookie[] m_cookies;
    private Service m_service = null;

    public SharedMultiplyServiceConsumer(String clientName)
    ...
    public SharedMultiplyServiceConsumer(String clientName, String environment)
        throws ServiceException
    {
        if (environment == null) {
    ...
    protected AsyncMultiplyService getProxy()
        throws ServiceException
    {
        m_service = getService();
    ...
    public Future<?> multiplyAsync(MultiplyRequest param0, AsyncHandler<MultiplyResponse> param1) {
        ...
        result = m_proxy.multiplyAsync(param0, param1);
        return result;
    }

    public Response<MultiplyResponse> multiplyAsync(MultiplyRequest param0) {
        Response<MultiplyResponse> result = null;
        try {
            m_proxy = getProxy();
        } catch (ServiceException serviceException) {
            throw ServiceRuntimeException.wrap(serviceException);
        }
        result = m_proxy.multiplyAsync(param0);
        return result;
    }
    ...
    public MultiplyResponse multiply(MultiplyRequest param0) {
        ...
        result = m_proxy.multiply(param0);
        return result;
    }
