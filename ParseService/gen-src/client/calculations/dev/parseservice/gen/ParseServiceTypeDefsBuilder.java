 ...
 * 
 */
public class ParseServiceTypeDefsBuilder
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #1 (ParseResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "ParseResponse")));
        // Type #2 (BaseRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS1, "BaseRequest")));
        // Type #3 (ParseRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "ParseRequest")));
        // Type #4 (ErrorData)
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(6), -1);
        currType.addSimpleElement(new QName(NS2, "input"), 1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "parseRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "parseRequest"), complexTypes.get(3)));
        rootElements.put(new QName(NS2, "parseResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "parseResponse"), complexTypes.get(1)));
    }
