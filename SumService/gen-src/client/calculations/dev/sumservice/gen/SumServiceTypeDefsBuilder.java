 ...
 * 
 */
public class SumServiceTypeDefsBuilder
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #1 (SumResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "SumResponse")));
        // Type #2 (BaseRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS1, "BaseRequest")));
        // Type #3 (SumRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "SumRequest")));
        // Type #4 (ErrorData)
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "sumResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "sumResponse"), complexTypes.get(1)));
        rootElements.put(new QName(NS2, "sumRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "sumRequest"), complexTypes.get(3)));
    }
