 ...
 * 
 */
public class PowerServiceTypeDefsBuilder
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #1 (PowerRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "PowerRequest")));
        // Type #2 (BaseResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS1, "BaseResponse")));
        // Type #3 (PowerResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "PowerResponse")));
        // Type #4 (ErrorData)
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addSimpleElement(new QName(NS1, "timestamp"), 1);
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(6), -1);
        currType.addSimpleElement(new QName(NS2, "z"), 1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "powerResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "powerResponse"), complexTypes.get(3)));
        rootElements.put(new QName(NS2, "powerRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "powerRequest"), complexTypes.get(1)));
    }
