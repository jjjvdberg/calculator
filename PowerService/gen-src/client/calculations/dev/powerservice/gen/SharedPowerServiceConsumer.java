 ...
 * 
 */
public class SharedPowerServiceConsumer
    implements AsyncPowerService
{

    private URL m_serviceLocation = null;
    private final static String SVC_ADMIN_NAME = "PowerService";
    private String m_clientName;
    private String m_environment = "production";
    private AsyncPowerService m_proxy = null;
    private String m_authToken = null;
    private Cookie[] m_cookies;
    private Service m_service = null;

    public SharedPowerServiceConsumer(String clientName)
    ...
    public SharedPowerServiceConsumer(String clientName, String environment)
        throws ServiceException
    {
        if (environment == null) {
    ...
    protected AsyncPowerService getProxy()
        throws ServiceException
    {
        m_service = getService();
    ...
    public Future<?> powerAsync(PowerRequest param0, AsyncHandler<PowerResponse> param1) {
        ...
        result = m_proxy.powerAsync(param0, param1);
        return result;
    }

    public Response<PowerResponse> powerAsync(PowerRequest param0) {
        Response<PowerResponse> result = null;
        try {
            m_proxy = getProxy();
        } catch (ServiceException serviceException) {
            throw ServiceRuntimeException.wrap(serviceException);
        }
        result = m_proxy.powerAsync(param0);
        return result;
    }
