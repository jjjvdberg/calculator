 ...
 * 
 */
public class NegateServiceTypeDefsBuilder
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #1 (NegateResponse)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "NegateResponse")));
        // Type #2 (BaseRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS1, "BaseRequest")));
        // Type #3 (NegateRequest)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "NegateRequest")));
        // Type #4 (ErrorData)
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "negateResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "negateResponse"), complexTypes.get(1)));
        rootElements.put(new QName(NS2, "negateRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "negateRequest"), complexTypes.get(3)));
    }
