...
public class Matrix {
	 ...
	 * component's values.
	 * 
	 * @param headers The headers of the components that were hit
	...
	public void addExecution(ArrayList<String> headers, Integer error) {
		...
		this.aim.addExecution(headers, error); // and update the AIM for this matrix
	}
...
//		System.out.println(this.components);
	...
	public void sortHittingSetsByError() {
		this.aim.sortByError();
	}
